  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link disabled" href="tablas.php">Tablas de Multiplicar</a>
        </li>
      </ul>
      <form class="d-flex">
...
<section>
    ...
    <!-- Se crea un formulario con 1 input de manera requerida -->
    ...
    <!--Se inicia el PHP junto con la generacion de tablas. -->
    <?php
    //Hacemos la validación del campo requerido.
    if(isset($_POST['numero'])){
        $numero = $_POST['numero'];

        echo "<h5>Tabla de multiplicación del número $numero: </h5>";
